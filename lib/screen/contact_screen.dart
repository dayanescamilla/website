...
class ContactScreen extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              IconButton(onPressed: () => _sendEmail(), icon: Image.asset(email, scale: 3)),
              IconButton(onPressed: () => _urlGithub(), icon: Image.asset(github, scale: 3)),
              IconButton(onPressed: () => _urlTwitter(), icon: Image.asset(twitter, scale: 3)),
              IconButton(onPressed: () => _urlTelegram(), icon: Image.asset(telegram, scale: 3)),
              IconButton(onPressed: () => _urlLinkedin(), icon: Image.asset(linkedin, scale: 3)),
            ],
          ),
  ...
  _urlTwitter(){
    final Uri twitterLaunchUri  = Uri.parse('https://pub.dev/packages/url_launcher');
